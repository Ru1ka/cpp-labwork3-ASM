...
# Комментарии
Это лабараторная работа с курса основ программирования в ИТМО на 09.03.02 2024/2025 учебного года. В условии есть некоторые ограничения, которые влияют на реализацию.
...
cd ..
mkdir output
./build/ASM -i example.tsv -o output -f 10000
```
